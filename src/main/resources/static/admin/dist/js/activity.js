$(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '地址', name: 'addr', index: 'addr', width: 50,align:"center"},
            {label: '备注', name: 'remark', index: 'remark', width: 50,align:"center"},
...
function search() {
    ...
    //提交post并刷新表格
    $("#jqGrid").jqGrid("setGridParam", {url: '/admin/activity/list'}).trigger("reloadGrid");
}
...
function editBlog() {
    ...
    window.location.href = "/admin/activity/edit/" + id;
}
