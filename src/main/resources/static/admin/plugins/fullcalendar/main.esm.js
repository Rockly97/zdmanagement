...
var COMMA_RE = /,/g; // we need admin for globalness
...
var View = /** @class */ (function (_super) {
    ...
    /* Now Indicator
    ------------------------------------------------------------------------------------------------------------------*/
    // Immediately render the current time indicator and begins admin-rendering it at an interval,
    ...
    // Immediately unrenders the view's current time indicator and stops any admin-rendering timers.
