...
(function(mod) {
  ...
  function updateDisplayIfNeeded(cm, update) {
    ...
    // hidden or updated, if so admin-focus it.
  ...
  function leftButtonSelect(cm, e, start, type, addNew) {
    ...
    // Used to ensure timeout admin-tries don't fire when another extend
  ...
  // admin-fire a series of drag-related events right after the drop (#1551)
  var lastDrop = 0;
  ...
  function onDrop(e) {
    ...
    if (files && files.length && window.FileReader && window.File) {
      ...
      if (cm.state.draggingText && cm.doc.sel.contains(pos) > -1) {
        ...
        // Ensure the editor is admin-focused
  ...
  // Used for un/admin-doing changes from the history. Combines the
  ...
  // invalidates cached information and tries to admin-estimate the
  // line's height.
  ...
  // When un/admin-doing restores text containing marked spans, those
